...
pub async fn get(
    ...
    let org = state.services.organization().get(user_id, organization_id).await?;
...
pub async fn update(
    ...
    let org = state.services.organization().update(user_id, organization_id, req).await?;
    Ok((StatusCode::OK, Json(org)))
}
...
pub async fn delete(
    ...
    state.services.organization().delete(user_id, organization_id).await?;
...
pub async fn assign_member(
    ...
    state.services.organization().assign_member(user_id, organization_id, target_user_id).await?;
...
pub async fn revoke_member(
    ...
    state.services.organization().revoke_member(user_id, organization_id, target_user_id).await?;
    Ok((StatusCode::NO_CONTENT, ()))
}
...
pub async fn list_members(
    ...
    let members = state.services.organization().list_members(user_id, organization_id).await?;
...
pub async fn assign_member_by_email(
    ...
    state
        .services
        .organization()
        .assign_member_by_email(user_id, organization_id, &req.email)
        .await?;
    Ok((StatusCode::CREATED, ()))
}
